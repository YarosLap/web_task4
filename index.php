...
$works = [
    [
        'name' => 'Тим лид в Apple',
        'dateStart' => 'Декабрь 2016',
        'dateEnd' => 'Текущее время',
        'description' => 'Тут описание работы тим лида в Apple.',
    ],
    [
        'name' => 'Программист в Microsoft',
        'dateStart' => 'Март 2011',
        'dateEnd' => 'Декабрь 2016',
        'description' => 'Тут описание работы программистом в Microsoft.',
    ],
    [
        'name' => 'Инженер по тестированию в Google',
        'dateStart' => 'Июль 2006',
        'dateEnd' => 'Март 2011',
        'description' => 'Тут описание работы инженера по тестированию в Google.',
    ],
    ]
?>
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i = 0; $i < count($works); $i++): ?>
            ...
            <h6 class="w3-text-teal">
                ...
                <?=$works[$i]['dateStart'];?> - <?=$works[$i]['dateEnd'];?>
            </h6>
